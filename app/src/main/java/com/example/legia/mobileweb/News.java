...
public class News extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("Tin tức công nghệ");

        listTinTuc = findViewById(R.id.listNews);
    ...
    public class ProcessInBackground extends AsyncTask<Integer, Void, Exception>
    {
        ...
        protected void onPreExecute() {
            ...
            progressDialog.setMessage("Đang tải nội dung...");
            progressDialog.show();
        }
        ...
        protected Exception doInBackground(Integer... params) {
            ...
            {
                Intent i = getIntent();
                Bundle b = i.getBundleExtra("news");
                String urlProvider = b.getString("urlProvider");

                URL url = new URL(urlProvider);
        ...
        protected void onPostExecute(Exception s) {
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(News.this, android.R.layout.simple_list_item_1, titles);
